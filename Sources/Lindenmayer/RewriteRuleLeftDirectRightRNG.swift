...
public struct RewriteRuleLeftDirectRightRNG<LC, DC, RC, PRNG>: Rule where LC: Module ,DC: Module, RC: Module, PRNG: RandomNumberGenerator {
    ...
    public typealias combinationMatchProducesList = (LC, DC, RC, RNGWrapper<PRNG>) throws -> [Module]
    ...
    public func produce(_ matchSet: ModuleSet) throws -> [Module] {
        ...
        return try produceClosure(leftInstance, directInstance, rightInstance, self.prng)
    }
}
