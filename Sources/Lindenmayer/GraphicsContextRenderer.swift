...
public struct GraphicsContextRenderer {
    ...
    public func draw(_ lsystem: LSystemProtocol, into context: inout GraphicsContext, ofSize size: CGSize? = nil) {
        if let size = size {
    ...
    public func calcBoundingRect(system: LSystemProtocol) -> CGRect {
