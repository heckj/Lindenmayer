...
///
/// - ``init(leftType:directType:rightType:where:produces:)``
///
...
public struct RewriteRuleLeftDirectRight<LC, DC, RC>: Rule where LC: Module, DC: Module, RC: Module {
    ...
    public typealias CombinationMatchProducesList = @Sendable (LC, DC, RC) -> [any Module]
    ...
    public func produce(_ matchSet: ModuleSet) -> [any Module] {
        ...
        return produceClosure(leftInstance, directInstance, rightInstance)
    }
}
