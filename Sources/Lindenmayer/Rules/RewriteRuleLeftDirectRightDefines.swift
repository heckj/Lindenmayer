//
//  RewriteRuleLeftDirectRightDefines.swift
//
//
...
///
/// - ``init(leftType:directType:rightType:parameters:where:produces:)``
///
...
public struct RewriteRuleLeftDirectRightDefines<LC, DC, RC, PType>: Rule where LC: Module, DC: Module, RC: Module, PType: Sendable {
    ...
    public typealias CombinationMatchProducesList = @Sendable (LC, DC, RC, PType) async -> [any Module]
    ...
    public func produce(_ matchSet: ModuleSet) async -> [any Module] {
        ...
        return await produceClosure(leftInstance, directInstance, rightInstance, parameters)
    }
}
...
extension RewriteRuleLeftDirectRightDefines: CustomStringConvertible {
    ...
    public var description: String {
        "Rule(left,direct,right)(\(String(describing: matchingTypes)) w/ parameters: \(String(describing: parameters))"
    }
}
