...
///
/// - ``init(directType:rightType:parameters:where:produces:)``
///
...
public struct RewriteRuleDirectRightDefines<DC, RC, PType>: Rule where DC: Module, RC: Module, PType: Sendable {
    ...
    public typealias CombinationMatchProducesList = @Sendable (DC, RC, PType) async -> [any Module]
    ...
    public func produce(_ matchSet: ModuleSet) async -> [any Module] {
        ...
        return await produceClosure(directInstance, rightInstance, parameters)
    }
}
