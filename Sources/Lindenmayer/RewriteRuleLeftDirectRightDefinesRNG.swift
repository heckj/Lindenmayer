...
public struct RewriteRuleLeftDirectRightDefinesRNG<LC, DC, RC, PType, PRNG>: Rule where LC: Module ,DC: Module, RC: Module, PRNG: RandomNumberGenerator {
    ...
    public typealias combinationMatchProducesList = (LC, DC, RC, PType, RNGWrapper<PRNG>) throws -> [Module]
    ...
    public func produce(_ matchSet: ModuleSet) throws -> [Module] {
        ...
        return try produceClosure(leftInstance, directInstance, rightInstance, self.parameters, self.prng)
    }
}
