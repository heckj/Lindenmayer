...
public struct RewriteRuleLeftDirectDefinesRNG<LC, DC, PType, PRNG>: Rule where LC: Module ,DC: Module, PRNG: RandomNumberGenerator {
    ...
    public typealias combinationMatchProducesList = (LC, DC, PType, RNGWrapper<PRNG>) throws -> [Module]
    ...
    public func produce(_ matchSet: ModuleSet) throws -> [Module] {
        ...
        return try produceClosure(leftInstance, directInstance, self.parameters, self.prng)
    }
}
